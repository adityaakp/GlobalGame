        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <?php 
                if(isset($error)) : ?>
                  <p style="color : green  ; font-size:15px; " class="login-card-description" > Right now the feature is not available, contact us via live chat below </P>
                <?php endif; ?>
              <form action=" " method="post">
                 ...
                 <button type="submit" name="reset" class="btn btn-block login-btn mb-4"> FORGOT PASSWORD</button> 
                </form>
